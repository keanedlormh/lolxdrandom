...
/**
 * Función de cálculo de puntería (Corregida en v1.1)
 */
...
function drawMinimap(ctx, me, hudBarHeight = 40) {
    ...
    // 1. Guardar contexto y crear área de recorte
    ctx.save();
    ctx.beginPath();
...
/**
 * Rellena la lista de salas activas
 */
