/**
 * server/server.js - ACTUALIZADO v1.5
 *
 * 1. (v1.4) 'joinGame' modificado para 'Join in Progress'.
 * 2. (v1.5) DEFAULT_CONFIG actualizado con `coreHealthMultiplier`.
 */
...
class Game {
    constructor(id, hostId, hostName, config) {
        ...
        // v1.5: Asegurarse que la config fusionada
...
io.on('connection', (socket) => {
    ...
    socket.on('createGame', (data) => {
        ...
        // v1.5: Fusionar config recibida con default
